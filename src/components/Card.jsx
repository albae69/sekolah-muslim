...
const Card = ({style, desc, title, tag, img}) => {
	return (
		<div
			style={style}
			className=" bg-white md:h-10/11 md:w-64 w-full transform hover:-translate-y-4 font-Nunito mb-10 rounded-lg overflow-hidden hover:shadow-xl bg-gray-10 mb-20"
		>
