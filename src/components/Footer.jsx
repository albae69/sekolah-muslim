	...
	return (
		<>
			<div className="h-full w-full pt-20 text-white  font-Nunito  flex justify-around justify-center flex-wrap">
				<div className="flex-grow  md:text-left text-center  mb-10   md:w-1/5 md:mx-32">
					<span className="text-4xl font-bold tracking-widest">
						Sekolah Muslim
					</span>
					<p className="text-base mx-5 md:mx-0">
				...
				<div className="flex-grow  mb-10 md:w-1/5  tracking-wider md:text-left text-center">
				...
				<div className="flex-grow mb-10 md:w-1/5 md:text-left text-center">
